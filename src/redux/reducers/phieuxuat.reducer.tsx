...
import {GET_LIST_PHIEUXUAT} from '../constants/index';

const initState: Array<PHIEUXUAT> = [
  {
    ID: 0,
    Code: '',
    IDNguoiNhap: 0,
...
const rdc_phieuxuat = (state = initState, action: any) => {
  switch (action.type) {
    case GET_LIST_PHIEUXUAT:
      console.log(action);
